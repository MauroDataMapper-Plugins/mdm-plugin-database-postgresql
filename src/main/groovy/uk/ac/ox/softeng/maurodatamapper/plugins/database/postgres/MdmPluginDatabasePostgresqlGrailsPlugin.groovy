...
class MdmPluginDatabasePostgresqlGrailsPlugin extends Plugin {
...
'''
    ...
    def scm = [url: "https://github.com/mauroDataMapper-plugins/mdm-plugin-database-postgresql"]
