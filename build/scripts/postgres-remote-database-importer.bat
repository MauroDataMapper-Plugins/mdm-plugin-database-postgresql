...
@rem ##########################################################################
@rem
@rem  postgres-remote-database-importer startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and POSTGRES_REMOTE_DATABASE_IMPORTER_OPTS to pass JVM options to this script.
set DEFAULT_JVM_OPTS="-DapplicationVersion=1.12.1-SNAPSHOT" "-Dmc.logFileName=postgres-remote-database-importer" "-Dgrails.env=CUSTOM"
...
:fail
rem Set variable POSTGRES_REMOTE_DATABASE_IMPORTER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%POSTGRES_REMOTE_DATABASE_IMPORTER_EXIT_CONSOLE%" exit 1
exit /b 1
